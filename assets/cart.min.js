...
class CartItems extends HTMLElement {
            ...
            .then((state) => {
                ...
                CartPerformance.measure(
                    ...
                    () => {
                        ...
                        this.updateCartGoal(updatedCartTotal);
                ...
                if (typeof fc_lazyBlurImages === 'function') {
                    fc_lazyBlurImages();
                }
            })
            .catch(() => {
    ...
    updateCartGoal(cartTotal, itemCount) {
        document.querySelectorAll('[data-cart-goal]').forEach(progressWrapper => {
            ...
            const progressBar = progressWrapper.querySelector('[data-progress-bar]');
            ...
            if (itemCount === 0 || cartTotal === 0) {
                ...
                if (goalMessageElement) {
                    ...
                    let remainingForGoal = Math.max(progressThreshold - cartTotal, 0);
                    const remainingAmount = (remainingForGoal / 100).toFixed(2);
                    const remainingAmountFormatted = moneyFormat.replace('{{amount}}', remainingAmount);
                    goalMessageElement.innerHTML = remainingForGoal > 0 ? preGoalMessageTemplate.replace('[remaining_amount]', remainingAmountFormatted) : postGoalMessage;
                }
            }
        });
    }
